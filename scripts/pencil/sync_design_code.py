...
ROUTE_TO_PEN = {
    ...
    "/templates/new": "pages/create/template-create.pen",
    "/shop": "pages/commerce/shop.pen",
    "/shop/new": "pages/create/shop-item-create.pen",
    "/points": "pages/points/points-list.pen",
    "/points/:id": "pages/detail/point-record-detail.pen",
